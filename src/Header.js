        ...
        <div class="transparent-hide">
            <nav>
                ...
                <ul className="">
                    ...
                    <li> <a href='/Aboutpage' className="link-style" >AboutUs</a></li>
                    <li><a href='/Gallery' className="link-style">Gallery</a></li>
                    ...
                    <div className="button-sec">
                        ...
                        <li className="button-style ms-4 link-style"><Link to={"/SViewcart"} className="link-style"><span className='cart-count'>{cart ? cart.length : null} </span><FontAwesomeIcon icon={faCartShopping} /></Link></li>
                    </div>
